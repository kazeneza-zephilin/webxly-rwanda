...
const projects = {
    ...
    4: {
        title: "ASPIRE Design Lab - Architecture Studio Website",
        subtitle:
            "A modern, professional website for a socially-conscious architecture practice focused on community-centered design and environmental advocacy.",
        heroImage: "./assets/images/asp-1.png",
        overview: [
            "ASPIRE Design Lab approached us to create a digital presence that reflects their unique philosophy and mission. They believe architecture is a social art form that requires active cultural engagement and community participation, and they needed a website that communicates this vision effectively.",
            "We designed and developed a clean, modern website that showcases ASPIRE's commitment to nurturing architecture as a social and environmental art form. The site highlights their practice of deep listening, research-driven approach, and dedication to creating spaces that celebrate identity and foster belonging.",
            "The website features a portfolio showcase of their architectural projects, an about section that articulates their mission and values, and a contact system for potential clients and collaborators. We crafted a visual identity that embodies their ethos of empathy-driven design and environmental consciousness.",
            "Through thoughtful UI/UX design and development, we created a platform that positions ASPIRE Design Lab as a forward-thinking architecture practice dedicated to the shared well-being of both people and planet.",
        ],
        features: [
            "Modern, responsive website design",
            "Portfolio showcase for architectural projects",
